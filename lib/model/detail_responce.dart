...
final nameValues = EnumValues({"VAT": Name.VAT, "VAT4": Name.VAT4});
...
class Ranking {
  ...
  factory Ranking.fromJson(Map<String, dynamic> json) => Ranking(
        ...
        products: List<RankingProduct>.from(
            json["products"].map((x) => RankingProduct.fromJson(x))),
      );
